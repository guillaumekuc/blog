...
- [Harmonic Relativity, Part 1 - Basics](https://youtu.be/kt5_LPC8epM?si=LonzW0tuprQqCDyE) – Music theory series exploring "harmonic relativity"-a practical system for categorizing and using chord relationships to evoke specific emotions and colors in your compositions, adaptable to any musical style.
